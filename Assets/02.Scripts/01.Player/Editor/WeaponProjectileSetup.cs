...
#pragma warning restore CS0618
    ...
    public static void FillWeaponAttackFrames()
    {
        ...
        var slice = new Dictionary<string, (int cols, int rows)>
        {
            ...
            // ── 17~24 신규 업로드 — 가로 1줄 스트립. 프레임 수 확정(경계 정렬 검증 완료) ──
            { "WPN_019", (17, 1) }, // 대검   7140px → 셀 420
            { "WPN_020", (17, 1) }, // 카타나 7140px → 셀 420
            { "WPN_021", (1, 1) },  // 스피어 594x570 — 창들이 겹친 단일 합성 이미지. 18프레임 타일 분할 불가(재출력 필요)
            { "WPN_022", (24, 1) }, // 플레일 7896px → 셀 329
            { "WPN_023", (11, 1) }, // 메이스 4840px → 셀 440
            { "WPN_024", (17, 1) }, // 몽둥이 7140px → 셀 420 (현재 020과 동일 파일 — 별도 이미지 필요)
        };
